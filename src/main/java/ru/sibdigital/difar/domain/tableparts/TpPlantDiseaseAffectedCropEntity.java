...
@Entity
@Table(name = "tp_plant_disease_affected_crop", schema = "agrc")
public class TpPlantDiseaseAffectedCropEntity {
    ...
    public boolean equals(Object o) {
        ...
        TpPlantDiseaseAffectedCropEntity that = (TpPlantDiseaseAffectedCropEntity) o;
