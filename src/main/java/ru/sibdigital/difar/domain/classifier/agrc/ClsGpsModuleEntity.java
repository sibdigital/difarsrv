...
public class ClsGpsModuleEntity extends ClsBaseEntity {
    ...
    public ClsGpsModuleEntity setIdUserCreator(long idUserCreator) {
    ...
    public ClsGpsModuleEntity setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ClsGpsModuleEntity setDateCreate(Date dateCreate) {
    ...
    public ClsGpsModuleEntity setDeleted(Boolean deleted) {
        isDeleted = deleted;
        return this;
    }
    ...
    public ClsGpsModuleEntity setNumber(String number) {
        this.number = number;
        return this;
    }
    ...
    @SequenceGenerator(name = "generator", sequenceName = "cls_gps_module_id_seq", schema = "agrc")
    public long getId() {
        return id;
    }

    public ClsGpsModuleEntity setId(long id) {
        this.id = id;
        return this;
    }
    ...
    public ClsGpsModuleEntity setIdOrganization(long idOrganization) {
    ...
    public ClsGpsModuleEntity setDescription(JsonNode description) {
...
//    }
//
//    public ClsGpsModuleEntity setPoint(Point point) {
//        this.point = point;
//    }
//
//    @Override
...
//    }
    ...
    public ClsGpsModuleEntity setClsOrganizationByIdOrganization(ClsOrganizationEntity clsOrganizationByIdOrganization) {
    ...
    public ClsGpsModuleEntity setRegGpsModuleOrganizationEquipmentsById(Collection<RegGpsModuleOrganizationEquipmentEntity> regGpsModuleOrganizationEquipmentsById) {
    ...
    public ClsGpsModuleEntity setRegGpsModuleReadingsById(Collection<RegGpsModuleReadingEntity> regGpsModuleReadingsById) {
