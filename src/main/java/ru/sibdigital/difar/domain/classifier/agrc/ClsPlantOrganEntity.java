...
public class ClsPlantOrganEntity extends ClsBaseEntity {
    ...
    public ClsPlantOrganEntity setIdUserCreator(long idUserCreator) {
    ...
    public ClsPlantOrganEntity setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ClsPlantOrganEntity setDateCreate(Date dateCreate) {
    ...
    public ClsPlantOrganEntity setDeleted(Boolean deleted) {
        isDeleted = deleted;
        return this;
    }
    ...
    public ClsPlantOrganEntity setNumber(String number) {
        this.number = number;
        return this;
    }
    ...
    public ClsPlantOrganEntity setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    @SequenceGenerator(name = "generator", sequenceName = "cls_plant_organ_id_seq", schema = "agrc")
    public long getId() {
        return id;
    }

    public ClsPlantOrganEntity setId(long id) {
        this.id = id;
        return this;
    }
    ...
    public ClsPlantOrganEntity setTpPlantDiseasePlantOrgansById(Collection<TpPlantDiseasePlantOrganEntity> tpPlantDiseasePlantOrgansById) {
    ...
    public ClsPlantOrganEntity setTpPlantPestPlantOrgansById(Collection<TpPlantPestPlantOrganEntity> tpPlantPestPlantOrgansById) {
