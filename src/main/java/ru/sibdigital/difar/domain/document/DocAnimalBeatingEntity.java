...
import ru.sibdigital.difar.domain.tableparts.TpAnimalBeatingAnimalEntity;
import ru.sibdigital.difar.domain.tableparts.TpAnimalBeatingAnimalGroupEntity;
...
@Entity
@Table(name = "doc_animal_beating", schema = "breed")
public class DocAnimalBeatingEntity {
    ...
    public boolean equals(Object o) {
        ...
        DocAnimalBeatingEntity that = (DocAnimalBeatingEntity) o;
    ...
    @OneToMany(mappedBy = "docAnimalBeatingByIdAnimalBeating")
