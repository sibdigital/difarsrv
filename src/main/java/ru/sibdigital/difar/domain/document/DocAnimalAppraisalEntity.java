...
import ru.sibdigital.difar.domain.tableparts.TpAnimalAppraisalAnimalEntity;
import ru.sibdigital.difar.domain.tableparts.TpAnimalAppraisalAnimalGroupEntity;
...
@Entity
@Table(name = "doc_animal_appraisal", schema = "breed")
public class DocAnimalAppraisalEntity {
    ...
    public boolean equals(Object o) {
        ...
        DocAnimalAppraisalEntity that = (DocAnimalAppraisalEntity) o;
