...
@Entity
@Table(name = "reg_animal_param", schema = "breed")
public class RegAnimalParamEntity {
    ...
    private ClsUnitEntity clsUnitByIdUnitWeight;
    ...
    public void setIdUnitWeight(long idUnitWeight) {
        this.idUnitWeight = idUnitWeight;
    }
    ...
    public boolean equals(Object o) {
        ...
        RegAnimalParamEntity that = (RegAnimalParamEntity) o;
        ...
        if (idUnitWeight != that.idUnitWeight) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (int) (idUnitWeight ^ (idUnitWeight >>> 32));
    ...
    @ManyToOne
    @JoinColumn(name = "id_unit_weight", referencedColumnName = "id", nullable = false)
    public ClsUnitEntity getClsUnitByIdUnitWeight() {
        return clsUnitByIdUnitWeight;
    }

    public void setClsUnitByIdUnitWeight(ClsUnitEntity clsUnitByIdUnitWeight) {
        this.clsUnitByIdUnitWeight = clsUnitByIdUnitWeight;
    }
}
