...
@Entity
@Table(name = "reg_organization_partner", schema = "dict")
public class RegOrganizationPartnerEntity {
    ...
    public boolean equals(Object o) {
        ...
        RegOrganizationPartnerEntity that = (RegOrganizationPartnerEntity) o;
