...
public class ClsAnimalParamKindControllerTest extends ClsBaseControllerTest {
    ...
    public void requestsTest() throws Exception {
        ...
        MvcResult result = this.mockMvc.perform(post("/animal-param-kind/create").contentType("application/json").content(json))
        ...
        this.mockMvc.perform(get("/animal-param-kind/" + id))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json"))
                .andExpect(jsonPath("$.name").value(DEFAULT_NAME))
                .andDo(print());
        ...
        this.mockMvc.perform(put("/animal-param-kind/update").contentType("application/json").content(json))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json"))
        ...
        this.mockMvc.perform(delete("/animal-param-kind/" + id))
                .andExpect(status().isOk())
