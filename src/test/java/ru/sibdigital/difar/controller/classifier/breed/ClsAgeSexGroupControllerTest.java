...
public class ClsAgeSexGroupControllerTest extends ClsBaseControllerTest {
    ...
    public void requestsTest() throws Exception {
        ...
        MvcResult result = this.mockMvc.perform(post("/age-sex-group/create").contentType("application/json").content(json))
        ...
        this.mockMvc.perform(get("/age-sex-group/" + id))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json"))
                .andExpect(jsonPath("$.name").value(DEFAULT_NAME))
                .andDo(print());
        ...
        this.mockMvc.perform(put("/age-sex-group/update").contentType("application/json").content(json))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json"))
        ...
        this.mockMvc.perform(delete("/age-sex-group/" + id))
                .andExpect(status().isOk())
