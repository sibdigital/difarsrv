...
public class ClsConsumableKindControllerTest extends ClsBaseControllerTest {
    ...
    public void requestsTest() throws Exception {
        ...
        MvcResult result = this.mockMvc.perform(post("/consumable-kind/create").contentType("application/json").content(json))
        ...
        this.mockMvc.perform(get("/consumable-kind/" + id))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json"))
                .andExpect(jsonPath("$.name").value(DEFAULT_NAME))
                .andDo(print());
        ...
        this.mockMvc.perform(put("/consumable-kind/update").contentType("application/json").content(json))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json"))
        ...
        this.mockMvc.perform(delete("/consumable-kind/" + id))
                .andExpect(status().isOk())
