...
public class ClsProtectionEquipmentControllerTest extends ClsBaseControllerTest {
    ...
    public void requestsTest() throws Exception {
        ...
        MvcResult result = this.mockMvc.perform(post("/protection-equipment/create").contentType("application/json").content(json))
        ...
        this.mockMvc.perform(get("/protection-equipment/" + id))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json"))
                .andExpect(jsonPath("$.name").value(DEFAULT_NAME))
                .andDo(print());
        ...
        this.mockMvc.perform(put("/protection-equipment/update").contentType("application/json").content(json))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json"))
        ...
        this.mockMvc.perform(delete("/protection-equipment/" + id))
                .andExpect(status().isOk())
