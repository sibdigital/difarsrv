...
public class ClsAnimalGroupKindControllerTest extends ClsBaseControllerTest {
    ...
    public void requestsTest() throws Exception {
        ...
        MvcResult result = this.mockMvc.perform(post("/animal-group-kind/create").contentType("application/json").content(json))
        ...
        this.mockMvc.perform(get("/animal-group-kind/" + id))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json"))
                .andExpect(jsonPath("$.name").value(DEFAULT_NAME))
                .andDo(print());
        ...
        this.mockMvc.perform(put("/animal-group-kind/update").contentType("application/json").content(json))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json"))
        ...
        this.mockMvc.perform(delete("/animal-group-kind/" + id))
                .andExpect(status().isOk())
