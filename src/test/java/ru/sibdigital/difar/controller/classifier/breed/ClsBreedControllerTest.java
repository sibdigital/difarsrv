...
public class ClsBreedControllerTest extends ClsBaseControllerTest {
    ...
    public void requestsTest() throws Exception {
        ...
        entity.setName(DEFAULT_NAME)
                ...
                .setClsKindAnimalByIdKindAnimal(kindAnimalRepository.findById(DEFAULT_ID).get());

        String json = ow.writeValueAsString(entity);

        MvcResult result = this.mockMvc.perform(post("/breed/create").contentType("application/json").content(json))
        ...
        this.mockMvc.perform(get("/breed/" + id))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json"))
                .andExpect(jsonPath("$.name").value(DEFAULT_NAME))
                .andDo(print());
        ...
        this.mockMvc.perform(put("/breed/update").contentType("application/json").content(json))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json"))
        ...
        this.mockMvc.perform(delete("/breed/" + id))
                .andExpect(status().isOk())
