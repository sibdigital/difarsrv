...
public class ClsLegalEntityControllerTest extends ClsBaseControllerTest {
    ...
    public void requestsTest() throws Exception {
        ...
        MvcResult result = this.mockMvc.perform(post("/legal-entity/create").contentType("application/json").content(json))
        ...
        this.mockMvc.perform(get("/legal-entity/" + id))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json"))
                .andExpect(jsonPath("$.name").value(DEFAULT_NAME))
                .andDo(print());
        ...
        this.mockMvc.perform(put("/legal-entity/update").contentType("application/json").content(json))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json"))
        ...
        this.mockMvc.perform(delete("/legal-entity/" + id))
                .andExpect(status().isOk())
