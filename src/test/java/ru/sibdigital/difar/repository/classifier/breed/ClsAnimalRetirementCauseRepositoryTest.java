...
@SpringBootTest
public class ClsAnimalRetirementCauseRepositoryTest extends ClsBaseTest {
    ...
    public void findDefaultEntryTest() {
        ClsAnimalRetirementCauseEntity clsAgeSexGroupEntity = repository.findById(DEFAULT_ID).get();
